          ...
          <table className="table-auto w-full border-collapse">
            <thead className="border-b text-left">
              <tr>
                ...
                {user && user.role === "admin" && <th className="px-4 py-2">Actions</th>}
              </tr>
            </thead>
            <tbody>
              {isLoading ? (
                <tr>
                  <td colSpan={user && user.role === "admin" ? 4 : 3} className="px-4 py-2 text-center">
                    <LoadingIndicator />
                  </td>
                </tr>
                ...
                users.map((_user) => (
                  <ManageUserTableRow key={_user.id} role={user.role} user={_user} />
                ))
              )}
            </tbody>
          </table>
